...
I set up a 2D board with living cells on it, with each iteration of the board, a new generation of cells will spawn.
The way a cell is spawned is based off a couple of rules:
